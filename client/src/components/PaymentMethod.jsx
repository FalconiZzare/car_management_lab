      ...
      <CardContent className="grid gap-6">
        ...
        <RadioGroup defaultValue="card" className="grid grid-cols-3 gap-4">
          <div>
            ...
            <Label
              htmlFor="card"
              className="flex cursor-pointer flex-col items-center justify-between rounded-md border-2 border-foreground bg-popover p-4 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-primary [&:has([data-state=checked])]:border-primary"
            >
              <svg
